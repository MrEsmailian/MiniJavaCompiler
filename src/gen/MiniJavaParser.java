package gen;// Generated from C:/Users/JConstantine/CE/Ferdowsi/Current.Semester.Courses/Compiler.Construction/Project/minijava/grammer/MiniJava.g4 by ANTLR 4.13.1
...
public class MiniJavaParser extends Parser {
	...
	public final MainMethodContext mainMethod() throws RecognitionException {
		...
		try {
			...
			match(LP);
			setState(63);
			((MainMethodContext)_localctx).dataType = type();
			setState(64);
			((MainMethodContext)_localctx).args = match(Identifier);
			setState(65);
			match(RP);
			setState(66);
			match(T__1);
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		public Token implemented;
		public Token implementeds;
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==T__7) {
				...
				match(T__7);
				setState(78);
				((ClassDeclarationContext)_localctx).extended = match(Identifier);
				}
			}
			...
			if (_la==T__8) {
				...
				match(T__8);
				setState(82);
				((ClassDeclarationContext)_localctx).implemented = match(Identifier);
				setState(87);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__9) {
					...
					match(T__9);
					setState(84);
					((ClassDeclarationContext)_localctx).implementeds = match(Identifier);
					}
					}
					setState(89);
					_errHandler.sync(this);
	...
	public static class InterfaceMethodDeclarationContext extends ParserRuleContext {
		public AccessModifierContext accModifier;
		public ReturnTypeContext retType;
	...
	public final InterfaceMethodDeclarationContext interfaceMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==T__3 || _la==T__14) {
				{
				setState(124);
				((InterfaceMethodDeclarationContext)_localctx).accModifier = accessModifier();
				}
			}

			setState(127);
			((InterfaceMethodDeclarationContext)_localctx).retType = returnType();
			setState(128);
	...
	public final FieldDeclarationContext fieldDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==T__3 || _la==T__14) {
				{
				setState(136);
				((FieldDeclarationContext)_localctx).accModifier = accessModifier();
				}
			}
			...
			if (_la==Final) {
				{
				setState(139);
				((FieldDeclarationContext)_localctx).isFinal = match(Final);
				}
			}

			setState(142);
			((FieldDeclarationContext)_localctx).dataType = type();
			setState(143);
			((FieldDeclarationContext)_localctx).varName = match(Identifier);
			setState(146);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==EQ) {
				...
				match(EQ);
				setState(145);
				((FieldDeclarationContext)_localctx).value = expression(0);
				}
			}
	...
	public final LocalDeclarationContext localDeclaration() throws RecognitionException {
		...
		try {
			...
			{
			setState(150);
			((LocalDeclarationContext)_localctx).dataType = type();
			setState(151);
			((LocalDeclarationContext)_localctx).varName = match(Identifier);
			setState(152);
			match(T__11);
			}
		}
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			if (_la==Override) {
				{
				setState(154);
				((MethodDeclarationContext)_localctx).override = match(Override);
				}
			}
			...
			if (_la==T__3 || _la==T__14) {
				{
				setState(157);
				((MethodDeclarationContext)_localctx).accModifier = accessModifier();
				}
			}

			setState(160);
			((MethodDeclarationContext)_localctx).retType = returnType();
			setState(161);
	...
	public final ParameterContext parameter() throws RecognitionException {
		...
		try {
			...
			{
			setState(179);
			((ParameterContext)_localctx).dataType = type();
			setState(180);
	...
	public final MethodBodyContext methodBody() throws RecognitionException {
		...
		try {
			...
			if (_la==RETURN) {
				...
				match(RETURN);
				setState(189);
				((MethodBodyContext)_localctx).returnValue = expression(0);
				setState(190);
				match(T__11);
				}
			}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				{
				setState(241);
				((VariableAssignmentStatementContext)_localctx).target = expression(0);
				setState(242);
				match(EQ);
				setState(243);
				expression(0);
			...
			case 6:
				...
				{
				setState(246);
				((ArrayAssignmentStatementContext)_localctx).target = match(Identifier);
				setState(247);
				match(LSB);
				setState(248);
				expression(0);
